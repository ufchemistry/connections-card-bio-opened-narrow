<?php
/**
 * Plugin Name:       Connections Bio Entry Opened Narrow - Template
...
?>
		...
		$thisLink = '';
		$echoLink = '';
		$link_types = ( isset($atts['link_types']) )? $atts['link_types'] : ''; 
		##if ( $atts['show_links'] ) {
			echo '<!--';
			$thisLink = $entry->getLinkBlock( array( 'format' => '%url%', 'type' => $link_types, 'return' => TRUE ) );
			echo '-->';
